...
This was a research project I cofounded at MobileLab while attending the University of Texas at Dallas. PlaceThings is a storytelling platform. It uses the iPhone to capture rich content such as photos, videos, audio, and text and attaches them location to a map. You can string this content together into a whole new kind of narrative, then share this narrative - in the form of a map of your content as waypoints - with friends and family by simply sending them a link. Others can then comment on your stories with the same kind of rich contnet. 

We offered a RESTful API to the public. This file is the PlaceThings View that handles requests to the API. This project was also created using Django.
